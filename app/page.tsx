      ...
      <section className="mb-22">
        <div className="mb-10 flex justify-between items-end">
          <div>
            ...
            <p className="text-body-m text-text-sub">가장 인기있는 게임에 참여해보세요</p>
          </div>
  ...
  return (
      <section className="flex flex-col-reverse gap-3 md:gap-0 md:flex-row p-6 md:p-16 items-center justify-between rounded-modal bg-[linear-gradient(155deg,_#fdf2f8_0%,_#eff6ff_100%)] mb-22">
        <div className="">
          ...
          <p className="mb-6 text-body-l">신나는 게임과 테스트를 하고 친구들과 공유해보세요</p>
          <div className="flex flex-wrap gap-3">
            <BaseLink variant="secondary" href="/" icon={<RocketIcon className="text-white" size={20} />}>
            게임하러 가기
            </BaseLink>
            <BaseLink variant="outline" href="/" >
            테스트하러 가기
            </BaseLink>
          </div>
        </div>
