...
export default function CheckIcon({
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 16 16">
        ...
        <path fill="#fff" fill-rule="evenodd" d="M11.978 5.129a.625.625 0 0 1 0 .883l-4.685 4.685a.665.665 0 0 1-.943 0L4.023 8.37a.625.625 0 1 1 .884-.884l1.915 1.915 4.272-4.272a.624.624 0 0 1 .884 0" clip-rule="evenodd"/>
      </g>
      <defs>
        <clipPath id="a">
