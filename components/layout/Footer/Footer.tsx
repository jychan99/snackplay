        ...
        <DialogDescription>
          <p>
            ...
            <p>
              ...
              1. "서비스"란 운영자가 제공하는 웹사이트 및 관련 기능을
              의미합니다. 2. "이용자"란 본 약관에 따라 서비스를 이용하는 회원 및
              방문자를 의미합니다. 3. "회원"이란 서비스에 가입하여 로그인 기능을
              이용하는 자를 의미합니다.
            </p>
            <p>
              {" "}
              제3조 (약관의 효력 및 변경) 1. 본 약관은 서비스 화면에
              게시함으로써 효력이 발생합니다. 2. 서비스는 필요한 경우 관련
              법령을 위반하지 않는 범위에서 약관을 변경할 수 있습니다. 3. 변경된
              약관은 서비스 내 공지 후 적용됩니다.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              관리해야 합니다. 2. 회원은 계정 정보가 유출되지 않도록 주의할
              책임이 있습니다. 3. 계정 관리 소홀로 발생한 문제에 대한 책임은
              회원에게 있습니다.
            </p>
            <p>
              제6조 (서비스 이용) 1. 서비스는 연중무휴 제공을 원칙으로 합니다.
              2. 다만, 시스템 점검 및 운영상 필요에 따라 일시적으로 서비스
              제공이 중단될 수 있습니다.
            </p>
            <p>
              제7조 (이용 제한) 서비스는 아래 행위를 금지합니다. * 타인의 계정
              도용 * 서비스 운영 방해 행위 * 불법적인 정보 게시 * 욕설, 비방,
              스팸 등 타인에게 피해를 주는 행위 서비스는 위 행위 발생 시 사전
              통보 없이 이용을 제한할 수 있습니다.
            </p>
            <p>
              {" "}
              제8조 (면책사항) 1. 서비스는 천재지변, 시스템 장애 등 불가항력으로
              발생한 문제에 대해 책임을 지지 않습니다. 2. 서비스는 이용자가
              게시한 정보에 대해 책임을 지지 않습니다. 3. 서비스는 이용자의
              귀책사유로 발생한 손해에 대해 책임을 지지 않습니다.{" "}
            </p>
            <p>
